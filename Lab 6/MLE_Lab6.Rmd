...
a*4
```
These are reasonably close, but we can do better with more iterations
...
hist(trials)
```
We took 100 samples of size 6 and then estimated the mean of those. What is `e` doing here?
